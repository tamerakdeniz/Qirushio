...
-- Bu script oyun tablolarını siler ve sıfırdan kurar. DİKKAT: OYUN VERİLERİ GİDER.
-- Kalıcı question_history özellikle korunur; reset tekrar engelleme hafızasını silmez.
...
-- Permanent question memory (migration 0013). Preserve it across game resets.
...
-- Generation deadline and more precise duplicate detection (migration 0014).
